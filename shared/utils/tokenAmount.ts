...
export const DECIMAL_SCALES: { [key: number]: bigint } = {
    0: BigInt('1'),
    1: BigInt('10'),
    2: BigInt('100'),
    3: BigInt('1000'),
    ...
    11: BigInt('100000000000'),
    12: BigInt('1000000000000'),
    13: BigInt('10000000000000'),
    14: BigInt('100000000000000'),
    15: BigInt('1000000000000000'),
    16: BigInt('10000000000000000'),
    17: BigInt('100000000000000000'),
...
export class TokenAmount {
    ...
    public static fromScale18Amount(
        ...
        const rawAmount = divUp
            ? BigInt(1) + (BigInt(scale18Amount) - BigInt(1)) / scalar
    ...
    public static fromInputAmount(
        ...
        const token = new Token(input.address, input.decimals);
    ...
    public mulUpFixed(other: bigint): TokenAmount {
        ...
        const multiplied = (product - BigInt(1)) / WAD + BigInt(1);
    ...
    public divUpFixed(other: bigint): TokenAmount {
        const divided = (this.amount * WAD + other - BigInt(1)) / other;
